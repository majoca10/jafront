        ...
        return {
            'request': function(config) {
                ...
                if(window.localStorage.token){
                   $httpProvider.defaults.headers.common['x-jacreditos-auth'] =  window.localStorage.token ;
                   $httpProvider.defaults.headers.common['x-jacreditos-user'] =  window.localStorage.uid || null  ; // common
                 }

                 if(window.localStorage.access_token){
                    $httpProvider.defaults.headers.common['access-token'] =  window.localStorage.access_token;
                    $httpProvider.defaults.headers.common['x-jacreditos-user'] = window.localStorage.user ? angular.fromJson(window.localStorage.user)._id : null // common
                 }
