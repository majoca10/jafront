...
$scope.ocupacion_records = [
    ...
    $scope.update = function(){
        ...
        if($rootScope.user.data.updated){
            ...
            'Identificación del Responsable de la Base de Datos Personales. JACREDITOS S.A.S, sociedad de carácter comercial identificada con NIT. 901091741-7, domiciliada en la Carrera 16 N 30 A 55, ciudad de Sincelejo, Sucre; correo electrónico soporte@jacreditos.com, teléfono de contacto 311 695 7745.' +
            'Uso de la Información Personal. Como parte de las actividades de prestación de servicios de JACREDITOS S.A.S, en particular estudio y otorgamiento de créditos, cobranza, actualización de datos, reporte a centrales de riesgo, contacto a clientes y usuarios, será requerida la entrega de datos tales como nombre, dirección, edad, así como otra información de contacto como número de teléfono y dirección electrónica e información específica en torno a referencias y condiciones económicas de los titulares de la información, así como otra información relevante proveniente del titular y las redes sociales de internet que nos permiten conocer a nuestros clientes y usuarios y facilitan el ejercicio de las actividades propias de la entidad.' +
            'Finalidades del Tratamiento de la Información. La información será tratada por JACREDITOS S.A.S de acuerdo con las siguientes finalidades:' +
            'Realizar ante los operadores de información (Datacrédito, Cifin y/o cualquier otra entidad que llegue a manejar bases de datos con los mismos objetivos) la consulta de la información crediticia, así como el reporte de la generación, modificación, extinción, cumplimiento o incumplimiento de las obligaciones contraídas en favor de JACREDITOS S.A.S y la utilización indebida de los productos y/o servicios prestados u ofrecidos por la entidad.' +
            ...
            'Utilizar los comentarios, artículos, fotos, videos y otros contenidos que se publican por los clientes o usuarios en nuestra página de internet, o que se presentan por cualquier otro medio de comunicación de JACREDITOS S.A.S para la realización de actividades comerciales o de mercadeo a través de nuestra página de internet, Facebook y otros medios de comunicación y utilizarlos como parte de nuestras campañas comerciales o de mercadeo dirigidas al público en general a través de distintos medios de comunicación.' +
            'Adelantar contactos con fines comerciales y promocionales ya sea sobre sus propios servicios y productos, o los de terceros con los que JACREDITOS S.A.S tenga relaciones comerciales o alianzas, a través de correo, teléfono, celular, correo electrónico o cualquier otro medio conocido o por conocer. Realizar actividades de gestión de cobro, aviso de reporte a las centrales de riesgo, entrega de extractos de obligaciones y actualizar la información a través de diferentes actividades como lo son la consulta en bases de datos públicas, páginas de internet y redes sociales y referencias de terceras personas.' +
            'El tratamiento de la información podrá realizarse por JACREDITOS S.A.S directamente o a través de terceros proveedores localizados en Colombia o en el exterior. Ese proceso puede implicar la recolección, archivo, procesamiento y transmisión de dicha información entre compañías vinculadas o relacionadas contractualmente con JACREDITOS S.A.S tales como proveedores del servicio de call y contact center, proveedores del servicio de mensajería, empresas de cobranza y profesionales del derecho que colaboran con la entidad para la recuperación de su cartera, localizadas dentro o fuera de Colombia. En todo caso, esas entidades estarán igualmente sujetas a las mismas obligaciones de confidencialidad en el manejo de la información a que está sujeto el JACREDITOS S.A.S con las limitaciones legales impuestas por las leyes aplicables sobre la materia, en la jurisdicción donde ésta se recolecte, archive, procese o transmita.' +
            'Se garantiza que JACREDITOS S.A.S, directamente, no utilizará o tratará para fines diferentes de los indicados, la información personal que contengan las bases de datos de nuestros clientes, usuarios y empleados.' +
            'Datos de Menores. JACREDITOS S.A.S no recopila ni trata datos de menores de edad. En caso de llegar a hacerlo y en virtud del régimen legal de protección de datos personales vigentes en Colombia, JACREDITOS S.A.S velará por el uso adecuado de los mismos en observancia de los principios y obligaciones contemplados en la Legislación Colombia de tratamiento de datos personales En garantía de los derechos fundamentales que le asisten a los niños y niñas o menores de edad y en caso que se deba obtener una información que verse sobre ellos, le asistirá al representante legal o acudiente dar la respectiva autorización previo ejercicio del menor de su derecho a ser escuchado, reservándose JACREDITOS S.A.S la posibilidad de dar conocimiento a las Autoridades pertinentes sobre situaciones que a su criterio causen o lleguen a causar una vulneración a los derechos de un menor de edad.' +
            'Tipos de Datos Tratados. JACREDITOS S.A.S en desarrollo de sus actividades comerciales y civiles capta y trata datos personales que son pertinentes y adecuados para la finalidad para la cual son recolectados o requeridos, los cuales conforme a la normatividad vigente y en virtud a nuestra actividad comercial son básicamente: 1. Datos públicos; 2. Datos semi- privados Y 3. Datos privados.' +
            ...
            'Datos Sensibles. En desarrollo de sus actividades JACREDITOS S.A.S no almacena o trata datos que se puedan considerar sensibles y que no resulten adecuados para sus labores comerciales. Sin embargo, En caso de requerirse este tipo de información para el adecuado desarrollo de las actividades adelantadas por JACREDITOS S.A.S los titulares deberán otorgar su autorización expresa, la cual deberá hacerse siempre de manera libre y voluntaria.' +
            ...
            'JACreditos S.A.S NIT 123456789-1</textarea>',
